    ...
    $.helpContent = {
        status: {
            ...
            CONTENT: [{
                ...
                //                  type: "name",
                //                  title: "USB Devices",
                //                  content: "Displays the USB device and printer connected to the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Total",
                //                  content: "Displays the total capacity of the connected USB device."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Available",
                //                  content: "Displays the available capacity of the connected USB device."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Printer",
                ...
                //                  type: "name",
                //                  title: "Performance",
                //                  content: "Displays the current performance of the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "CPU Load",
                //                  content: "Displays the current CPU utilization rate of the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Memory Usage",
                //                  content: "Displays the current memory usage of the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Access Devices",
                //                  content: "Displays all the devices connected to the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Wired Clients",
                //                  content: "Displays the wired devices connected the the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Wireless Clients",
                //                  content: "Displays the wireless devices connected the the router."
                //              },
                //              {
                //                  type: "name",
                //                  title: "CPU Load",
        ...
        INTERNET_PPPOE: {
            ...
            CONTENT: [{
                ...
                title: "Note",
                content: [
                    "1. Sometimes the connection cannot be disconnected although you specify a Max Idle Time (0~99 mins) because some applications are visiting the Internet continually in the background.",
                    "2. Only when you have set the system time on <strong>System Tools -> Time Settings</strong> page, the Time-based function can take effect."
                ]
            }, {
                type: "paragraph",
        ...
        LAN_IPV4: {
            ...
            CONTENT: [{
                type: "title",
                content: "You can configure the IP parameters of LAN on this page.",
                children: [{
                    type: "name",
                    title: "MAC Address",
                    ...
                    type: "name",
                    title: "IGMP Proxy",
                    content: "If you want to watch TV through IGMP, please Enable it."
                }]
            }, {
                type: "note",
                title: "Note",
        ...
        DHCP_SERVER: {
            ...
            CONTENT: [{
                    ...
                    content: [
                        "1. Enter the MAC Address (The format for the MAC Address is XX-XX-XX-XX-XX-XX) and the IP address in dotted-decimal notation of the computer you wish to add. Add description for your adding item which is optional. Select or not enable this entry.",
        ...
        ADVANCED_ROUTING: {
            ...
            CONTENT: [{
                ...
                title: "",
                content: [
                    "3. Click the <strong>checkbox</strong> to Enable the entry.",
                    "4. Click the <strong>OK</strong> button to save the changes."
                ]
            }, {
                type: "note",
                ...
                content: [
                    ...
                    "2. Click <strong>Modify</strong> or <strong>Delete</strong> as desired on the Modify column."
                ]
            }, {
                type: "title",
        ...
        alg: {
            ...
            CONTENT: [{
                ...
                //              {
                //                  type: "name",
                //                  title: "Enable NAT Control",
                //                  content: "If NAT Control enabled, the NAT function and the Virtual Server,Port Triggering, DMZ, UPNP configuration will take effect."
                //              },
                //              {
                //                  type: "name",
                //                  title: "Disable NAT Control",
                //                  content: "If NAT Control disabled, either NAT function, Virtual Server, Port Triggering, DMZ or UPNP configuration will not take effect. "
                //              },
                {
                    type: "name",
                ...
                //                  type: "name",
                //                  title: "ALG",
                //                  content: "It is recommended to enable because ALG allows customized Network Address Translation (NAT) traversal filters to be plugged into gateway to support address and port translation for certain application layer \"control/data\" protocols: FTP, TFTP, H323 etc."
                //              },
                {
                    type: "name",
                    title: "FTP ALG",
                    ...
                    type: "name",
                    title: "SIP ALG"
                    //                  content: "To allow some media player clients to communicate with some streaming media servers across NAT, check/uncheck the box to enable/disable it."
                },
        ...
        virtualServer: {
            ...
            CONTENT: [{
                ...
                //              {
                //                  type: "paragraph",
                //                  content: "Click <strong>Add</strong> icon."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Select the service you want to use from the Common Service list. If not included , enter the number of the external port or external port range in the external port box."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Enter the IP address of the computer running the service application in the IP Address box."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Click <strong>View Existing Service</strong> button to choose the protocol used for this application."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Select the Enabled option in the Enable this entry check."
                //              },
                //              {
                //                  type: "paragraph",
                ...
                //                  type: "name",
                //                  title: "Note",
                //                  content: "It is possible that you have a computer or server that has more than one type of available service. If so, select another service, and type in the same IP address for that computer or server."
                //              },
                //              {
                //                  type: "title",
                //                  content: "To modify or delete an existing entry:"
                ...
                //              {
                //                  type: "paragraph",
                //                  content: "Find the desired entry in the table."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Click Modify or Delete as desired on the Modify column."
                //              },
                //              {
                //                  type: "paragraph",
                //                  content: "Select the all entries, click <strong>Delete</strong> icon, it will delete all the entries."
                //              }
            ]
        },
        ...
        STREAM_BOOST_NETWORK: {
            ...
            CONTENT: [{
                type: "title",
                content: "Arrow Indicators to/from Internet:",
                children: [{
                    type: "name",
                    title: "Towards Router",
                    content: "Bandwidth being used by all devices connected to the router (download bandwidth)"
                }, {
                    type: "name",
                    title: "Towards Internet",
                    content: "Bandwidth being sent by all devices connected to the router (upload bandwidth)"
                }]
            }, {
                type: "title",
        ...
        STREAM_BOOST_DEVICES: {
            TITLE: "Network Devices Help",
            CONTENT: [{
                type: "title",
                content: "Application Icons",
                children: [{
                    type: "name",
                    title: "Identified Apps",
                    content: "Icons indicate complete detection and traffic shaping policies are in force."
                }, {
                    type: "name",
                    title: "Generic App Classes",
                    content: "Indicate apps that are detected to a class of applications and an appropriate policy is set for that class of apps."
                }, {
                    type: "name",
                    title: "Web",
                    content: "General Traffic"
                }, {
                    type: "name",
                    title: "Web Video",
                    content: "Streaming"
                    ...
                    content: "Indicates detected traffic that has no specific policies applied"
                }]
            }, {
                type: "title",
        ...
        STREAM_BOOST_BANDWIDTH: {
            TITLE: "Bandwidth Help",
            CONTENT: [{
                type: "title",
                content: "Enable StreamBoost Bandwidth Control",
                children: [{
                    type: "paragraph",
                    content: " Checking this box enables the StreamBoost traffic shaping capabilities."
                }, {
                    type: "paragraph",
                    content: "If not selected, the router will operate as a standard router without network quality of service"
                }]
            }, {
                type: "title",
        ...
        STREAM_BOOST_PRIORITY: {
            ...
            CONTENT: [{
                type: "title",
                content: "Changing Device Priority",
                children: [{
                    type: "paragraph",
                    content: "use the arrows to shift one position up or down in priority  Or, use the arrows of Stick to shift to the highest priority."
                }, {
                    type: "paragraph",
                    content: "1 is the highest priority"
                }]
            }, {
                type: "title",
        ...
        STREAM_BOOST_STATISTICS_UPTIME: {
            TITLE: "Statistics Uptime Help",
            CONTENT: [{
                type: "title",
                content: "Graph",
                children: [{
                    type: "paragraph",
                    content: "The top five applications by how much time they are using the network."
                }]
            }, {
                type: "name",
                title: "Time Range",
        ...
        STREAM_BOOST_STATISTICS_DOWNLOADS: {
            TITLE: "StreamBoost: Statistics Downloads Help",
            CONTENT: [{
                type: "title",
                content: "Graph",
                children: [{
                    type: "paragraph",
                    content: "The top applications by how many bytes they have downloaded."
                }]
            }]
        },
        ...
        MAC_FITLERING: { //临时使用，内容有问题！！！！！！！！！！！！！！！！！！！！！！
            ...
            CONTENT: [{
                ...
                children: [{
                    ...
                    title: "",
                    content: [
                        " 1. click <strong>View Existing Devices</strong>, and choose one entry, fill <strong>MAC Address field automatically.",
                        " 2. Enter a simple description of the wireless station in the <strong>Description</strong> field. ",
                        " 3. Select <strong>Enable this entry</strong> or not. ",
                        " 4. Click the <strong>OK</strong> button to save this entry or <strong>Cancel</strong> button to cancel your operation. "
                    ]
                }, {
                    type: "name",
                    title: "Delete",
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                //                              {type: "name",title: "WPA-PSK",content: "Pre-shared key of WPA."},
                                {
                                    type: "name",
                                    title: "WPA2-PSK",
        ...
        wirelessStat: {
            ...
            CONTENT: [{
                type: "title",
                content: "Wireless Stations Online"
            }, {
                type: "name",
                title: "ID",
                /*conf*/
        ...
        DISK_SETTING: {
            ...
            CONTENT: [{
                    ...
                    title: "Note",
                    content: [
                        "1. The router can automatically scan for a most recent plugged-in USB device.",
                        "2. Aftering clicking Safely Remove, you must re-plug USB device or click Scan to make it found again.",
                        "3. If there is data interaction in the current volume, click Safely Remove may not work.",
                        "4. The shared state of current volume will directly affect shared state settings in Folder Sharing page."
                    ]
                }
        ...
        parentCtrl: {
            ...
            CONTENT: [{
                    ...
                    content: [
                        'Click Add.',
                        'Click View Existing Devices and choose a currently connected device from the Access Devices List; or enter the Device Name and MAC Address manually to add a device that is not connected.',
                        'Click the Internet Access Time icon to specify a time period during which the restriction applies.',
                        'Enter a brief description into the Description field. (Optional)',
                        'Select Enable.',
                ...
                //              },{
                //                  type: "paragraph",
                //                  content: "In black list mode, any websites containing keywords from blacklist will be blocked to those controlled devices by the router."
                //              },{
                //                  type: "paragraph",
                //                  content: "In white list mode, only the websites in whitelist  are open to those controlled devices. "
                //              },{
                //                  type: "paragraph",
                //                  content: "You can fill the blanks with the keywords of the websites you want to block or the domain name of the websites you allow to access (like www.yahoo.com)."
                //              }
            ]
        },
        SECURITY_SETTING: {
        ...
        accessControl: {
            ...
            CONTENT: [{
                    ...
                    type: "title",
                    content: "Devices in List" /*change*/
                }, {
                    type: "note",
        ...
        TIME_SETTING: {
            ...
            CONTENT: [{
                ...
                content: [
                    "1. Select your local time zone from this pull-down list. ",
                    "2. Select your date.",
                    "3. Configure your time.",
                    "4. Click <strong>Save</strong> button."
                ]
            }, {
                type: "note",
                title: "For automatic time synchronization: ",
                content: [
                    "1. Click <strong>Get GMT</strong> button to update the time from the Internet with the pre-defined servers.",
                    "2. Click <strong>Save</strong> button."
                ]
            }, {
                type: "note",
                title: "OR ",
                content: [
                    "1. Enter the IP address or domain name of your desired server in NTP Server field first.",
                    "2. Click <strong>Get GMT</strong> button to update the time from Internet with the entered server.",
                    "3. Click <strong>Save</strong> button."
                ]
            }]
        },
        TIME_SETTING_DAYLIGHT: {
            ...
            CONTENT: [{
                ...
                title: "Note: ",
                content: [
                    "1. Some time-based functions such as firewall will not work if time is not set. Therefore, it is important to configure time settings as soon as you successfully login to the Router.",
        ...
        DIGNOSTIC: {
            ...
            CONTENT: [{
                ...
                content: [
                    "1. Check the radio button before ping.",
                    "2. Enter the IP address or domain name.",
                    "3. Click the drop-down icon before Advanced to display Ping Count, Ping Packet size and Ping Timeout. Keep these parameters at their default values or configure them according to your needs.",
                    "4. Click Start button to begin the dianosing."
                ]
            }, {
                type: "paragraph",
                content: "OR"
                ...
                content: [
                    "1. Check the radio button before traceroute.",
                    "2. Enter the IP address or domain name.",
                    "3. Click the drop-down icon before Advanced to display Traceroute Max TTL. Keep it at its default value or configure it according to your need.",
                    "4. Click Start button to begin the dianosing."
                ]
            }]
        },
        FIRMWARE: {
            ...
            CONTENT: [{
                ...
                content: [
                    "1. Click <strong>Browse?/strong> to locate and select the new firmware file.",
                    "2. Click <strong>Upgrade</strong> button."
                ]
            }, {
                type: "paragraph",
        ...
        BACKUP: {
            ...
            CONTENT: [{
                ...
                type: "note",
                content: [
                    "1. Click the Browse?button to locate and select the file you have backuped.",
                    "2. Click the Restore button to begin the restore process."
                ]
            }, {
                type: "name",
                ...
                type: "note",
                content: [
                    "1. Factory Restore will erase any settings that you have configured in the router.",
                    "2. Both the backup and restore process take a couple of minutes. Please do not power off the router until the process finishes."
                ]
            }]
        },
        ADMIN_ACCOUNT: {
        ...
        ADMIN_LOCAL: {
            ...
            CONTENT: [{
                ...
                content: [
                    "1. Click the    or    icon.",
                    "2. Enter the MAC address or use the View Existing Devices button to select an existing one.",
                    "3. Create a description for the rule.",
                    "4. Select or diselect the checkbox before Enable this Entry.",
        ...
        wlGuestDulBandAdv: {
            ...
            CONTENT: [

                {
                    ...
                    type: "title",
                    content: "Wireless Settings" /*change*/
                }, {
                    type: "name",
                ...
                //                  type: "name",
                //                  title:"Hide SSID",
                //                  content: "The SSID will be hidden from the Wi-Fi network."
                //              },
                //              {
                //                  type: "name",
                //                  title:"Password",
        ...
        BASIC_FILE_SHARE_DISK: {
            ...
            CONTENT: [{
                ...
                type: "note",
                title: "Note:",
                content: ["1. The router can automatically scan for a most recent plugged-in USB device.",
                    "2. Aftering clicking Safely Remove, you must re-plug USB device or click Scan to make it found again.",
                    "3. If there is data interaction in the current volume, click Safely Remove may not work.",
                    "4. The shared state of current volume will directly affect shared state settings in Folder Sharing page."
                ]
        ...
        BASIC_FILE_SHARE_SETTING: {
            ...
            CONTENT: [{
...

                {
                    ...
                    title: "Note:",
                    content: [
                        "1. The modified settings will take effect within 5 seconds.",
                        "2. The disabled volumes in Disk Settings page will not be shared, and related entries will not be displayed either.",
                        "3. All the settings of shared directories will be deleted when Sharing All box is selected. Please think twice before you make a move."
                    ]
                }
            ]
        },
        ...
        usbManage: {
            ...
            CONTENT: [{
                ...
                type: "paragraph",
                content: "The Device Settings page displays related information of all the USB storage device connected via the USB port." /*t*/
            }, {
                type: "name",
                title: "Scan",
                ...
                type: "name",
                title: "Share All",
                content: "Toggle On to share all the files and folders or Off to only share the selected folders." /*t*/
            }, {
                type: "name",
                title: "Enable Authentication",
        ...
        printSrv: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Connect a USB printer to the USB port of the router via a USB cable.",
                    "Install the printer driver on your computer. Refer to the computer manufacturer’s manuals for instructions.",
                    "Install the TP-LINK USB Printer Controller Utility either from the Resource CD (for Windows only) or download it (for both Windows and Mac OS X) from TP-LINK’s official website."
                ]
            }]
        },
        diskSettings: {
        ...
        softup: {
            ...
            CONTENT: [{
                type: "paragraph",
                content: "Before upgrading the firmware of the router, you will need to download the latest firmware update from the TP-LINK Support to your computer." /*?*/ //"TP-LINK Support" is a link?
            }, {
                type: "note",
                ...
                content: [
                    ...
                    "Make sure you have remove all the USB storage devices connected to the router before the firmware upgrade to prevent data loss." /*t*/ ,
        ...
        backNRestore: {
            ...
            CONTENT: [{
                ...
                title: "Note:",
                content: [
                    "Factory Restore will erase all the settings that you have configured for the router. To re-login to the router's management page, use the default admin for both username and password.",
        ...
        manageCtrl: {
            ...
            CONTENT: [{
                    ...
                    type: "paragraph",
                    content: "You can change your login username and/or password." /*t*/
                }, /*?*/ //Not necessary, 3 behind
                {
                    type: "name",
                    title: "Old Password",
                    ...
                    type: "name",
                    title: "New Password",
                    content: "Type in your new password." /*?*/ //Type in
                }, {
                    type: "name",
                    title: "Confirm New Password",
                    ...
                    type: "paragraph",
                    content: "You can limit the number of client devices on your LAN from accessing the router using the MAC address-based authentication." /*?*/ //port?
                }, {
                    type: "name",
                    title: "Port",
                    content: "" /**/
        ...
        log: {
            ...
            // },
            // snmp: {
            //     TITLE: "SNMP Settings Help",
            //     CONTENT: [{
            //         type: "name",
            //         title: "Enable SNMP Agent",
            //         content: "" /**/
            //     }, {
            //         type: "name",
            ...
            //  {
            //      type: "title",
            //      content: "WAN Interface"
            //  },
            //  {
            //      type: "name",
            //      title: "WAN Interface Name",
            //      content: "" /**/
            //  },
            //  {
            //      type: "name",
            //      title: "VPI/VCI or VID",
            //      content: "" /**/
            //  },
            //  {
            //      type: "name",
            ...
            //  {
            //      type: "title2",
            //      content: "Internet Connection Setup"
            //  },
            //  {
            //         type: "name",
            //         title: "DSL Modulation Type",
        ...
        route: {
            ...
            CONTENT: [{
                ...
                content: [
                    "Click Add.",
                    "Destination Network - Enter an IP address in hexadecimal to assign the static route for this entry.",
                    "Subnet Mask - Enter a subnet mask in hexadecimal format to determine the network portion and host portion of the IP address.",
                    "Gateway - Enter a gateway IP address in hexadecimal format to connect the router to the network or host.",
                    "Interface - Select LAN or WAN to specify the type of the Destination Network.",
                ...
                title: "To modify or delete an existing entry",
                content: [
                    "In the table, click the Edit icon or the Trash icon that corresponds to the entry that you wish to modify or delete."
                ]
            }, {
                type: "title",
        ...
        ddns: {
            ...
            CONTENT: [{
                ...
                content: [
                    ...
                    "Enter the Domain Name you received from the DDNS service provider.",
                    "Select your update interval from the drop-down list.",
        ...
        dhcp: {
            ...
            CONTENT: [{
                type: "title",
                content: "DHCP Server" /**/ //the following content
            }, {
                "type": "name",
                "title": "DHCP",
                ...
                content: [
                    "Click Add.",
                    "Enter the MAC address of your desired client.",
                ...
                content: [
                    "In the table, click the Edit icon or the Trash icon that corresponds to the client that you wish to modify or delete."
                ]
            }, {
                type: "title",
                content: "Condition Pool" /**/ //the following content
            }]
        },
        ethWan: {
            TITLE: "WAN Interface Help",
            CONTENT: [{
                "type": "title",
                "title": "Internet Connection Type: Static IP"
            }, {
