...
(function($) {
    $.helpContent = {
        "trafficCtrl": {
            ...
            "CONTENT": [{
                    "type": "paragraph",
                    "content": "Bandwidth Control allows you to configure the Upstream Bandwidth and Downstream Bandwidth of the network. The values you configure should be less than 100000kbps. For optimal control of the bandwidth, please select the right Line Type and consult your ISP for the total bandwidth of the egress and ingress."
                }, {
                    "type": "name",
                    "title": "Enable",
        ...
        "macFilter": {
            ...
            CONTENT: [{
                ...
                content: "Select to block wireless access from the devices in the below list."
            }, {
                type: "name",
                title: "Allow wireless access from the devices only in the below list.",
                content: "Select to allow wireless access only from the devices in the below list."
            }, {
                type: "title",
                title: "Devices List"
            }, {
        ...
        "wirelessSchedule": {
            ...
            "CONTENT": [{
                ...
                "type": "name",
                "title": "Restore",
                "content": "Click to the time selection."
            }, {
                "type": "name",
                "title": "Save",
        ...
        "wlGuestDulBandAdv": {
            ...
            "CONTENT": [{
                ...
                "content": "Select this checkbox to allow the wireless devices on the Guest Network to access your local network shares."
            }, {
                "type": "name",
        ...
        "wlGuestDulBandBasic": {
            ...
            "CONTENT": [{
                ...
                "type": "name",
                "title": "Allow guests to access my shared USB storage",
                "content": "Select this checkbox to allow wireless devices on the Guest network to access the shared contents on your USB storage."
            }, {
                "type": "name",
                "title": "Enable Wireless Network 2.4GHz/5GHz",
                "content": "Select this checkbox to enable the  Wireless 2.4GHz/5GHz Guest Network feature."
        ...
        "ddos": {
            ...
            "CONTENT": [{
                ...
                "type": "name",
                "title": "Forbid Ping Packets From LAN Port",
                "content": "Enable to ignore pings from LAN ports."
            }, {
                "type": "name",
                "title": "Forbid Ping Packets From WAN Port",
        ...
        "sysconf": {
            ...
            "CONTENT": [{
                    "type": "name",
                    "title": "Beacon Interval",
                    "content": "Enter a value between 200 and 1000 in milliseconds to determine the duration between beacon packets that are broadcasted by the router to synchronize the wireless network. The default is 200 milliseconds."
                }, {
                    "type": "name",
                    "title": "RTS Threshold",
                    "content": "Enter a value between 1 and 2346 to determine the packet size of data transmission through the router. By default, the RTS (Request to Send) Threshold size is 2346. If the packet size is greater than the preset threshold, the router sends Request of Send frames to a particular receiving station and negotiates the sending of a data frame, or else the packet will be sent immediately."
            ...
            }, */
                {
                    ...
                    "type": "name",
                    "title": "TCP-SYN-FLOOD Packets Level",
