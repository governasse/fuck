	...
	$.su.CHAR.HELP = {
		...
		LAN_IPV4: {
			...
			CONTENT: [{
				...
				type: "name",
				title: "IGMP Proxy",
				content: "The Internet Group Management Protocol (IGMP) is used to implement IPTV (Internet Protocol television) multicast routing on the network. By default, this feature is enabled."
			}*/,{
				type: "note",
				title: "Note",
		...
		DDNS: {
			...
			CONTENT: [{
				...
				content: [
					"1. Select your DDNS service provider.",
					"2. Enter the Username and Password of your DDNS account.",
					"3. Enter the Domain Name you received from the DDNS service provider.",
		...
		PRINT_SERVER: {	
			...
			CONTENT: [{
				...
				content: [
					"1. Connect a USB printer to the USB port of the router via a USB cable.",
					"2. Install the printer driver on your computer. Refer to the computer manufacturer’s manuals for instructions.",
					"3. Install the TP-LINK USB Printer Controller Utility, either from the Resource CD (for Windows only) or download it (for both Windows and Mac OS X) from TP-LINK’s official website."
				]
			}]
		},
		...
		PARENTAL_CONTROL_DEVICES: {
			...
			CONTENT: [{
				type: "name",
				title: "Device Name",
				content: "Displays the name of all connected client devices that are currently under the Parental Control."
			},{
				type: "name",
				title: "MAC Address",
				content: "Displays the MAC address of all connected client devices that are currently under the Parental Control."
			},{
				type: "name",
		...
		QOS_RULE: {
			...
			CONTENT: [{
				...
				content: [
					...
					"3. Select your desired application from the Application list, or you can customize an application by configuring the name, protocol and port in the corresponding fields.",
					"4. Click OK."
				]
			}/*,{
				type: "step",
		...
		ADMIN_LOCAL: {	
			...
			CONTENT: [{
				...
				content: [
					...
					"3. Enter a Description for the device. (Optional)",
					"4. Select Enable.",
					"5. Click OK."
				]
			},{
